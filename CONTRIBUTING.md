...
To be honest, we regard every user of Serverless Devs as a very kind contributor. After experiencing Serverless Devs, you may have some feedback for the project. Then feel free to open an issue via [NEW ISSUE](https://github.com/Serverless-Devs/agentrun-sdk-python/issues/new/choose).
...
1. **FORK** Serverless Devs to your repository. To make this work, you just need to click the button Fork in right-left of [Serverless-Devs/agentrun-sdk-python](https://github.com/Serverless-Devs/agentrun-sdk-python) main page. Then you will end up with your repository in `https://github.com/<your-username>/agentrun-sdk-python`, in which `your-username` is your GitHub username.
...
1. **Set Remote** upstream to be `git@github.com:Serverless-Devs/agentrun-sdk-python.git` using the following two commands:

```
git remote add upstream git@github.com:Serverless-Devs/agentrun-sdk-python.git
...
```
$ git remote -v
origin     git@github.com:<your-username>/agentrun-sdk-python.git (fetch)
origin     git@github.com:<your-username>/agentrun-sdk-python.git (push)
upstream   git@github.com:Serverless-Devs/agentrun-sdk-python.git (fetch)
...
Right now we assume every contribution via pull request is for [branch develop](https://github.com/Serverless-Devs/agentrun-sdk-python/tree/develop) in agentrun-sdk-python. Before contributing, be aware of branch definition would help a lot.
